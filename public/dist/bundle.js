...
// てすとサンプル
{
    const test = __webpack_require__(120);
    test.test();
    const greet = __webpack_require__(124);
    greet("hoge");
}
...
var example = __webpack_require__(121);
...
var hello = "hello";
var greet = function (name) { return console.log(hello + "! I'm " + name + "! from typescript."); };
